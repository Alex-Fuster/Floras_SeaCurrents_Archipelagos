...
Check dimensions-stress plots

```{r}
# Galapagos (k = 2)

# nmds_stress_plot(dist_mat_all_litt_gal) 
# nmds_stress_plot(mat_geo_gal) #2
# nmds_stress_plot(mat_medianMin_sym_Galapagos) #2
# nmds_stress_plot(mat_age_gal)
# nmds_stress_plot(mat_area_gal)
# 
# # Canaries
# 
# nmds_stress_plot(dist_mat_all_litt_can) #2
# nmds_stress_plot(mat_geo_can) #2
# nmds_stress_plot(mat_medianMin_sym_Canaries) #2
# nmds_stress_plot(mat_age_can)
# nmds_stress_plot(mat_area_can)
# 
# # Azores
# 
# nmds_stress_plot(dist_mat_all_litt_az) #2
# nmds_stress_plot(mat_geo_az) #2
# nmds_stress_plot(mat_medianMin_sym_Azores) 
# nmds_stress_plot(mat_age_az)
# nmds_stress_plot(mat_area_az)
```
...
#ggsave(here::here("c_output/figures/corr_floras_k2_excl_present.png"), height = 4, width = 8)
```
...
df_cor_curr_factors[which(df_cor_curr_factors$Island == "Azores"), "Geographic.space"] <- 0.99 # avoid rounding to 1
