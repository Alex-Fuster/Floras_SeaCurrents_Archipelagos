...
m_all_gal <- df_Galapagos[which(df_Galapagos$X25 == "0"),]
...
m_all_nonadapted_gal <- subset(df_Galapagos, !df_Galapagos$X25 %in% c("0.5", "1") & !df_Galapagos$X28 %in% c("presence", "exclusive"))
m_all_nonadapted_gal <- m_all_nonadapted_gal %>% select(2,7:18)
```
